...
public class Record implements Serializable {
	...
	private static final long serialVersionUID = 4115037738502476627L;
	...
	public Record setContainerFactoryByConfigName(String configName) {
		Config config = DbUtil.getConfig(configName);
		if (config == null)
	...
	public Map<String, Object> getColumns() {
		if (columns == null) {
			if (DbUtil.config == null)
				columns = DbUtil.brokenConfig.containerFactory.getColumnsMap();
			else
				columns = DbUtil.config.containerFactory.getColumnsMap();
		}
		return columns;
	}
	...
	public String toJson() {
		return JsonUtil.toJson(getColumns(), 4);
	}
}
