...
public class Db {
	...
	static <T> List<T> query(Config config, Connection conn, String sql,
	 ...
	 * Execute sql update
	 */
	static int update(Config config, Connection conn, String sql,
			Object... paras) throws SQLException {
	...
	static List<Record> find(Config config, Connection conn, String sql,
			Object... paras) throws SQLException {
	 ...
	 */
	public static Record findById(String tableName, Number idValue,
			String columns) {
		return pro.findById(tableName, idValue, columns);
	}

	/**
	 * Find record by id. Example: Record user = Db.findById("user", "user_id",
	 * 15);
	 * 
	 * @param tableName
	 *            the table name of the table
	 ...
	 *            the id value of the record
	 */
	public static Record findById(String tableName, String primaryKey,
			Number idValue) {
	 ...
	 * @return true if delete succeed otherwise false
	 */
	public static boolean deleteById(String tableName, String primaryKey,
			Object id) {
	 ...
	 * @return true if delete succeed otherwise false
	 */
	public static boolean delete(String tableName, String primaryKey,
			Record record) {
	...
	static Page<Record> paginate(Config config, Connection conn,
			int pageNumber, int pageSize, String select,
			String sqlExceptSelect, Object... paras) throws SQLException {
		return pro.paginate(config, conn, pageNumber, pageSize, select,
	...
	static boolean save(Config config, Connection conn, String tableName,
			String primaryKey, Record record) throws SQLException {
	 ...
	 */
	public static boolean save(String tableName, String primaryKey,
			Record record) {
	...
	static boolean update(Config config, Connection conn, String tableName,
			String primaryKey, Record record) throws SQLException {
	 ...
	 */
	public static boolean update(String tableName, String primaryKey,
			Record record) {
	 ...
	 */
	public static List<Record> findByCache(String cacheName, Object key,
	 ...
	 * @return Page
	 */
	public static Page<Record> paginateByCache(String cacheName, Object key,
			int pageNumber, int pageSize, String select,
			String sqlExceptSelect, Object... paras) {
		return pro.paginateByCache(cacheName, key, pageNumber, pageSize,
				select, sqlExceptSelect, paras);
	}
	...
	public static int[] batch(String sql, String columns,
			List modelOrRecordList, int batchSize) {
