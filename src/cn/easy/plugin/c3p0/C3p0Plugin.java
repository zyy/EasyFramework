...
public class C3p0Plugin implements IPlugin, IDataSourceProvider {
	...
	public C3p0Plugin(String jdbcUrl, String user, String password,
		...
		initC3p0Properties(jdbcUrl, user, password, driverClass, maxPoolSize,
				minPoolSize, initialPoolSize, maxIdleTime, acquireIncrement);
	}

	private void initC3p0Properties(String jdbcUrl, String user,
	...
	public C3p0Plugin(Properties properties) {
		...
		initC3p0Properties(ps.getProperty("jdbcUrl"), ps.getProperty("user"),
