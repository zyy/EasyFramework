...
public class FreeMarkerRender extends Render {
	...
	private static final long serialVersionUID = 5045255447040297716L;
	...
	/**
	 * Set freemarker's property. The value of template_update_delay is 5
	 * seconds. Example: FreeMarkerRender.setProperty("template_update_delay",
	 * "1600");
	 */
	public static void setProperty(String propertyName, String propertyValue) {
		try {
			FreeMarkerRender.getConfiguration().setSetting(propertyName,
					propertyValue);
	...
	static void init(ServletContext servletContext, Locale locale,
			int template_update_delay) {
	...
	public void render() {
		...
		try {
			...
			template.process(root, writer); // Merge the data-model and the
											// template
		} catch (Exception e) {
