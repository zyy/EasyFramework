...
public class VelocityRender extends Render {
	...
	private static final long serialVersionUID = 2080642730591786835L;
	...
	public void render() {
		if (notInit) {
			Velocity.init(properties); // Velocity.init("velocity.properties");
			notInit = false;
		}
		...
		try {
			...
			throw new RenderException("Example : error : cannot find template "
					+ view, e);
