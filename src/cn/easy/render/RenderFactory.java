...
import static cn.easy.core.Const.DEFAULT_FILE_RENDER_BASE_PATH;
import java.io.File;
...
public class RenderFactory {
	...
	/**
	 * Return Render by default ViewType which config in EasyFrameworkConfig
	 */
	...
	public Render getDefaultRender(String view) {
		...
		if (viewType == ViewType.FREE_MARKER) {
			...
			return new VelocityRender(view
					+ constants.getVelocityViewExtension());
		} else {
			return mainRenderFactory.getRender(view
	...
	private static final class VelocityRenderFactory implements
			IMainRenderFactory {
		public Render getRender(String view) {
			return new VelocityRender(view);
		}
