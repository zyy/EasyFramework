...
public class JsonRender extends Render {
	...
	public JsonRender(final String key, final Object value) {
		...
		this.jsonText = JsonUtil.mapToJson(new HashMap<String, Object>(){{put(key, value);}}, convertDepth);
	}
	...
	public JsonRender(Object object) {
		...
		this.jsonText = JsonUtil.toJson(object, convertDepth);
	}
	...
	private void buildJsonText() {
		...
		this.jsonText = JsonUtil.mapToJson(map, convertDepth);
	}
}
