...
public abstract class InterceptorStack implements Interceptor {
	...
	public InterceptorStack() {
		...
		if (interList == null)
			throw new RuntimeException(
					"You must invoke addInterceptors(...) to config your InterceptorStack");
	...
	protected final InterceptorStack addInterceptors(
	...
	public final void intercept(ActionInvocation ai) {
		new ActionInvocationWrapper(inters, ai).invoke();
	}
