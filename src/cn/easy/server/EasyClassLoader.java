...
public class EasyClassLoader extends WebAppClassLoader {
	private boolean initialized = false;

	public EasyClassLoader(WebAppContext context, String classPath)
			throws IOException {
		super(context);
		if (classPath != null) {
			String[] tokens = classPath.split(String
