...
import cn.easy.log.ILoggerFactory;
import cn.easy.log.Logger;
import cn.easy.render.IErrorRenderFactory;
import cn.easy.render.IMainRenderFactory;
import cn.easy.render.RenderFactory;
import cn.easy.render.ViewType;
...
public final class Constants {
	...
	public void setUrlParaSeparator(String urlParaSeparator) {
		if (StringUtil.isEmpty(urlParaSeparator) || urlParaSeparator.contains("/"))
	...
	public void setFileRenderPath(String fileRenderPath) {
		if (StringUtil.isEmpty(fileRenderPath))
	...
	public void setUploadedFileSaveDirectory(String uploadedFileSaveDirectory) {
		if (StringUtil.isEmpty(uploadedFileSaveDirectory))
